 ...
 */
public class dosage_form_fragment extends Fragment {
    ...
    public dosage_form_fragment(String key, boolean isAntibiotic) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_dosage_form_fragment, container, false);
        ...
        if(isAntibiotic) {
            DatabaseReference reference = FirebaseDatabase.getInstance().getReference("ANTIBIOTIC-AVALIBLE-DOSAGEFORM").child(key);
            ...
            DatabaseReference reference = FirebaseDatabase.getInstance().getReference("ANTIPYRETIC-AVALIBLE-DOSAGEFORM").child(key);
            reference.addValueEventListener(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    dosageformList.clear();
