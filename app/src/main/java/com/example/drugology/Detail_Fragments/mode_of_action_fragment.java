 ...
 */
public class mode_of_action_fragment extends Fragment {
    ...
    public mode_of_action_fragment(String key, boolean isAntibiotic) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_mode_of_action_fragment, container, false);
        ...
        if(isAntibiotic) {
            DatabaseReference reference = FirebaseDatabase.getInstance().getReference("ANTIBIOTIC-MODE-OF-ACTION").child(key);
            ...
            DatabaseReference reference = FirebaseDatabase.getInstance().getReference("ANTIPYRETIC-MODE-OF-ACTION").child(key);
            reference.addValueEventListener(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    dosageformList.clear();
