...
public class contraindication_fragment extends Fragment {
    ...
    public contraindication_fragment(String key, boolean isAntibiotic) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_contraindication_fragment, container, false);
        ...
        if(isAntibiotic) {
            DatabaseReference reference = FirebaseDatabase.getInstance().getReference("ANTIBIOTIC-CONTRAINDICATIONS").child(key);
            ...
            DatabaseReference reference = FirebaseDatabase.getInstance().getReference("ANTIPYRETIC-CONTRAINDICATION").child(key);
            reference.addValueEventListener(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    dosageformList.clear();
